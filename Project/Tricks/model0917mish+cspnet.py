...
def yolo_body(inputs, num_anchors, num_classes):
    ...
    """在backbone之后加入SPP模块"""
    """DBL*3"""
    x = DarknetConv2D_BN_Leaky(512,(1,1))(feat3)
    ...
    sppout = compose(
        ...
        DarknetConv2D_BN_Leaky(512, (1, 1)))(maxcon)

    x, y1 = make_last_layers(sppout, 512, num_anchors*(num_classes+5))
...
def box_ciou(b1, b2):
    ...
    v = 4 * K.square(tf.math.atan2(b1_wh[..., 0], K.maximum(b1_wh[..., 1], K.epsilon())) - tf.math.atan2(b2_wh[..., 0],K.maximum(
                                                                                                             b2_wh[
                                                                                                                 ..., 1],
                                                                                                             K.epsilon()))) / (
                    math.pi * math.pi)
