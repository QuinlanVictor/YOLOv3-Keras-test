...
def RFB(x,num_filters):
    x1 = DarknetConv2D_BN_Leaky(num_filters//4,(1,1))(x)
    x1 = RFBConv2D_BN(num_filters,(3,3),dilation_rate=1)(x1)

    x2 = DarknetConv2D_BN_Leaky(num_filters//4,(1,1))(x)
    x2 = DarknetConv2D_BN_Leaky(num_filters//4,(3,3))(x2)
    x2 = RFBConv2D_BN(num_filters//4,(3,3),dilation_rate=3)(x2)

    x3 = DarknetConv2D_BN_Leaky(num_filters//4, (1, 1))(x)
    x3 = DarknetConv2D_BN_Leaky(num_filters//4, (5, 5))(x3)
    x3 = RFBConv2D_BN(num_filters//4, (3, 3), dilation_rate=5)(x3)
