...
from yolo3.model1111 import preprocess_true_boxes, yolo_body, yolo_loss
...
def _main():
    ...
    model = create_model(input_shape, anchors, num_classes,
        freeze_body=2, load_pretrained=False) # make sure you know what you freeze
...
def create_model(input_shape, anchors, num_classes, load_pretrained=True, freeze_body=2,
    ...
    if load_pretrained:
        ...
        if freeze_body in [1, 2]:
            ...
            num = (185, len(model_body.layers)-2)[freeze_body-1]
