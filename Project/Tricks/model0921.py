...
def resblock_body(x, num_filters, num_blocks, all_narrow=True):
    ...
    preconv1 = DarknetConv2D(num_filters, (3, 3), strides=(2, 2))(preconv1)

    # 生成一个大的残差边
    shortconv = DarknetConv2D(num_filters // 2 if all_narrow else num_filters, (1, 1))(preconv1)
    ...
    # 1x1卷积后和残差边堆叠
    postconv = DarknetConv2D(num_filters // 2 if all_narrow else num_filters, (1, 1))(mainconv)
