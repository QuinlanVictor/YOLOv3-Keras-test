...
1212 if A > 10000 and A < 100000:这个标准好一些
     B[2] < col_size / 5 * 4
'''
...
def make_lungmask(img, display=False):
    ...
    for prop in regions:
        ...
        if A > 10000 and A < 100000:
            if B[2] - B[0] < row_size / 10 * 10 and B[3] - B[1] < col_size / 10 * 10 and B[0] > row_size / 11 and B[
                2] < col_size :
...
def raw2mask():
    ...
    for root, dirs, files in os.walk(int_path):
        for filename in files:  # 遍历所有文件
            ...
            Img=(mask*gray)
            cv2.imwrite("E:\Data\LIDC\Segmentationjpg/png12113/" + filename, Img)
